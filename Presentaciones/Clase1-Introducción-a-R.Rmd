...
knitr::include_graphics(file.path("../images/Consola2.jpg"))
```
---
...
knitr::include_graphics(file.path("../images/new_directory.png"))
...
knitr::include_graphics(file.path("../images/new_directory3.png"))
```
