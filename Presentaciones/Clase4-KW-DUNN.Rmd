...
**Hipótesis nula (H₀)**: Las muestras independientes tienen la misma tendencia centra (distribución)l y, por lo tanto, provienen de la misma población.
...
data <- data.frame(
  mobility_scores = c(group_A, group_B, group_C),  # Concatenate all group scores
